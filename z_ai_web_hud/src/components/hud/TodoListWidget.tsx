...
import { CheckSquare, Square, Plus, Trash2, Maximize2, X, ListTodo } from "lucide-react";
    ...
    <>
      <div className="chamfer-card light-pipe-cyan glass-panel p-4 w-56 flex flex-col group transition-all duration-300 hover:shadow-[0_0_25px_rgba(0,242,255,0.3)]">
        ...
        >
          ...
          <button className="text-cyan/70 hover:text-cyan transition-colors" title="Expand View">
            <Maximize2 size={14} />
          </button>
        </div>
        <div className="mt-3 font-mono text-[9px] text-cyan/50 tracking-widest font-bold">
