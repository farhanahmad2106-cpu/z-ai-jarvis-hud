...
export function TodoListWidget() {
  ...
  return (
    <div className="chamfer-card light-pipe-cyan glass-panel p-4 w-56 flex flex-col gap-3 group transition-all duration-300 hover:shadow-[0_0_25px_rgba(0,242,255,0.3)]">
